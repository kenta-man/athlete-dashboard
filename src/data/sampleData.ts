...
const DEFS: [string, string, number, number, number, number, number, number, number][] = [
  ...
  ['Lucas Wagner',  'DF', 10, -150, -0.8, -1,  1.0,  1.0, 1996],
  ...
  ['Marcus Carter', 'FW', 26, -250,  1.5, -1, -1.5, -1.0, 1995],
